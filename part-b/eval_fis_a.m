...
fis_files = dir('section_a_fis/*.fis');
...
for i = 1:num_files
    ...
    fis = readfis(append('section_a_fis/', fname));
...
best_fis = readfis(append('section_a_fis/', best_model_name));
writeFIS(best_fis, 'santoso_part_B_section_a.fis')
