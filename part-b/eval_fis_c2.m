...
fis_files = dir('section_c2_fis/*.fis');
...
for i = 1:num_files
    ...
    fis = readfis(append('section_c2_fis/', fname));
...
best_fis = readfis(append('section_c2_fis/', best_model_name));
writeFIS(best_fis, 'santoso_part_B_section_c2.fis')
